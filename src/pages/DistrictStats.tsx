...
const DistrictStats = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold">District Performance</h1>
        <p className="text-muted-foreground">{user?.district} District Health Statistics</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Health scheme progress in the district</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Health scheme coverage by sub-districts</CardDescription>
        </CardHeader>
        <CardContent className="px-2">
          <div className="space-y-4">
            {["North Region", "South Region", "East Region", "West Region", "Central Region"].map((region, i) => (
